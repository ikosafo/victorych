        ...
        <div class="sidebar-content">
            ...
            <nav class="main-menu">
                <ul class="nav metismenu">
                    ...
                    <li class="<?php echo($_SERVER['PHP_SELF'] == "/administrator/donate.php"
                        ? "active" : ""); ?> nav-dropdown">
                        <a href="donate.php"><i class="icon dripicons-tag"></i><span>Donate</span></a>
                    </li>
            ...
            <ul class="navbar-nav nav-center site-logo">
                <li>
                    <a href="index.php">
                        ...
                        <span class="brand-text">VIC</span>
                    </a>
                </li>
            </ul>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-pill user-avatar" data-toggle="dropdown" href="#" role="button"
                       aria-haspopup="true" aria-expanded="false">
                        <img src="assets/img/logo1.jpg" class="w-35 rounded-circle" alt="VIC Logo">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-accout">
                        <div class="dropdown-header pb-3">
                            <div class="media d-user">
                                <img class="align-self-center mr-3 w-40 rounded-circle"
                                     src="assets/img/logo1.jpg" alt="VIC Logo">
                                <div class="media-body">
                                    <h5 class="mt-0 mb-0">Administrator</h5>
                                    <span>Victory Chapel International</span>
                                </div>
                            </div>
                        </div>
